...
class RequestManager
{
    ...
    public function doRequest(PaazlRequest $requestObject)
    {
        ...
        try {
            ...
            if (isset($response->error) && !in_array($response->error->code, [1003]) && ($response->error->code == 1053 && $requestObject->getMethod() != 'checkoutStatus')) { // 1053 = missing permission for Paazl Perfect, 1003 = An order with this reference already exists
                $paazlError = [
